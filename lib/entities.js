...
{
  "news1": "This word appears in the first 12,000 words out of 24,000 words from Mainichi Shimbun frequency list by Alexandre Gira",
  "news2": "This word appears in the second 12,000 words out of 24,000 words from Mainichi Shimbun frequency list by Alexandre Gira",
  "ichi": "This word appears in \\"Ichimango goi bunruishuu\\", Senmon Kyouiku (10,000 vocabularies collection)",
...
export function getTagDescription(tag) {
  ...
  if (tag === 'ichi1' || tag === 'ichi1') {
    return Priorities.ichi;
  }

  // TODO: Add NF calculation
